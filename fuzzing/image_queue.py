...
class TensorInputCorpus(FuzzQueue):
    ...
    def __init__(self,outdir, israndom, sample_function, threshold, algorithm, log):
        """Init the class.
        ...
        FuzzQueue.__init__(self, outdir, israndom, sample_function, 1, 'Near', log)
    ...
    def build_index_and_flush_buffer(self):
        ...
        """
        self.log("Total %s Flushing buffer and building index.", len(self.corpus_buffer))
        self.corpus_buffer[:] = []
...
class ImageInputCorpus(FuzzQueue):
    def __init__(self, outdir, israndom, sample_function, cov_num, criteria, log):
        """Init the class.
        ...
        Returns:
          Initialized object.
        """
        FuzzQueue.__init__(self, outdir, israndom, sample_function, cov_num, criteria, log)
